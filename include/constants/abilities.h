...
enum __attribute__((packed)) Ability
{
    ...
    //New Abilities Added for this ROM Hack
    ABILITY_SOUL_EATER = ABILITIES_COUNT_GEN9,
    ABILITY_LEI = 312,
    ABILITY_ALPHA_BETA = 313,
    ABILITY_AIRBORNE = 314,
    ABILITY_ELEMENTAL = 315,
    ABILITY_MIND_OVER_MATTER = 316,
    ABILITY_PUFF_UP = 317, 
    ABILITIES_COUNT_ALL,
    ABILITIES_COUNT = ABILITIES_COUNT_ALL,
};
