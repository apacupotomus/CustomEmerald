...
const struct SpeciesInfo gSpeciesInfoGen2[] =
{
    ...
    [SPECIES_FURRET] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD),
        .abilities = { ABILITY_PICKPOCKET, ABILITY_KEEN_EYE, ABILITY_FRISK }, //PICKPOCKET 1
        .bodyColor = BODY_COLOR_BROWN,
    ...
    [SPECIES_HOOTHOOT] =
    {
        ...
        .abilities = { ABILITY_INSOMNIA, ABILITY_TINTED_LENS, ABILITY_MINDS_EYE }, //TINTED LENS 2, MINDS EYE 3
        .bodyColor = BODY_COLOR_BROWN,
    ...
    [SPECIES_LEDIAN] =
    {
        ...
        .growthRate = GROWTH_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_BUG),
        .abilities = { ABILITY_SWARM, ABILITY_SUPER_LUCK, ABILITY_PIXILATE }, //SUPER LUCK 2, PIXILATE 3
        .bodyColor = BODY_COLOR_RED,
...
#define TOGEPI_FAMILY_TYPE1 (P_UPDATED_TYPES >= GEN_6 ? TYPE_FAIRY : TYPE_NORMAL)
    ...
    [SPECIES_TOGETIC] =
    {
        ...
        .abilities = { ABILITY_HEALER, ABILITY_SERENE_GRACE, ABILITY_SUPER_LUCK }, //HEALER
        .bodyColor = BODY_COLOR_WHITE,
        .noFlip = TRUE,
    ...
    [SPECIES_TOGEKISS] =
    {
        ...
        .growthRate = GROWTH_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FLYING, EGG_GROUP_FAIRY),
        .abilities = { ABILITY_HEALER, ABILITY_SERENE_GRACE, ABILITY_SUPER_LUCK }, //HEALER 1
        .bodyColor = BODY_COLOR_WHITE,
        .noFlip = TRUE,
    ...
    [SPECIES_NATU] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FLYING),
        .abilities = { ABILITY_SYNCHRONIZE, ABILITY_FOREWARN, ABILITY_MAGIC_BOUNCE }, //FOREWARN 2
        .bodyColor = BODY_COLOR_GREEN,
        .speciesName = _("Natu"),
        .cryId = CRY_NATU,
    ...
    [SPECIES_MAREEP] =
    {
        ...
        .abilities = { ABILITY_STATIC, ABILITY_FLUFFY, ABILITY_LIGHTNING_ROD }, //FLUFFY 2, LIGHTNING_ROD 3
        .bodyColor = BODY_COLOR_WHITE,
        .noFlip = TRUE,
    ...
    [SPECIES_SUDOWOODO] =
    {
        ...
        .abilities = { ABILITY_SAP_SIPPER, ABILITY_ROCK_HEAD, ABILITY_DISGUISE }, //SAP SIPPER 1, DISGUISE 3
        .bodyColor = BODY_COLOR_BROWN,
    ...
    [SPECIES_AIPOM] =
    {
        ...
        .growthRate = GROWTH_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD),
        .abilities = { ABILITY_PICKPOCKET, ABILITY_PICKUP, ABILITY_SKILL_LINK }, //PICKPOCKET 1
    ...
    [SPECIES_SUNFLORA] =
    {
        ...
        .baseSpAttack  = 105,
        .baseSpDefense = 85,
        .types = MON_TYPES(TYPE_GRASS, TYPE_ELECTRIC), //added electric type
        .catchRate = 120,
        ...
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_GRASS),
    #if P_UPDATED_ABILITIES >= GEN_4
        .abilities = { ABILITY_VOLT_ABSORB, ABILITY_SOLAR_POWER, ABILITY_LIGHTNING_ROD },
    #else
        .abilities = { ABILITY_CHLOROPHYLL, ABILITY_NONE, ABILITY_EARLY_BIRD },
    #endif
        .bodyColor = BODY_COLOR_YELLOW,
    ...
    [SPECIES_YANMA] =
    {
        ...
        .baseSpAttack  = 75,
        .baseSpDefense = 45,
        .types = MON_TYPES(TYPE_BUG, TYPE_DRAGON), //Swapped from Bug/Flying to Bug Dragon
        .catchRate = 75,
    ...
    [SPECIES_MISDREAVUS] =
    {
        ...
        .abilities = { ABILITY_LEVITATE, ABILITY_NONE, ABILITY_AFTERMATH }, //AFTERMATH 3
...
#define UNOWN_MISC_INFO(letter, _noFlip, frontWidth, frontHeight, backWidth, backHeight, backYOffset)   \
    {                                                                                                   \
        ...
        .growthRate = GROWTH_MEDIUM_FAST,                                                               \
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_NO_EGGS_DISCOVERED),                                      \
        .abilities = { ABILITY_ALPHA_BETA, ABILITY_NONE, ABILITY_NONE },                                  \
        .bodyColor = BODY_COLOR_BLACK,                                                                  \
        .noFlip = _noFlip,                                                                              \
        .speciesName = _("Unown"),                                                                      \
        .cryId = CRY_UNOWN,                                                                             \
    ...
    [SPECIES_GIRAFARIG] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD),
        .abilities = { ABILITY_INNER_FOCUS, ABILITY_EARLY_BIRD, ABILITY_SAP_SIPPER },//unchaged for now, future new ability "upside down" inverse battle effect.
        .bodyColor = BODY_COLOR_YELLOW,
    ...
    [SPECIES_GLIGAR] =
    {
        ...
        .baseSpAttack  = 35,
        .baseSpDefense = 65,
        .types = MON_TYPES(TYPE_GROUND, TYPE_POISON), //CHANGED TO FLYING TO POISON, ADDED AIRBORNE ABILITY FOR GROUND IMMUNITY
        .catchRate = 60,
    ...
    [SPECIES_QWILFISH] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_WATER_2),
        .abilities = { ABILITY_POISON_POINT, ABILITY_IRON_BARBS, ABILITY_INTIMIDATE },
        .bodyColor = BODY_COLOR_GRAY,
    ...
    [SPECIES_SHUCKLE] =
    {
        ...
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_BUG),
    #if P_UPDATED_ABILITIES >= GEN_4
        .abilities = { ABILITY_STURDY, ABILITY_GLUTTONY, ABILITY_CONTRARY }, //add new ability "Juice Maker"
    #else
    ...
    [SPECIES_WEAVILE] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD),
        .abilities = { ABILITY_INNER_FOCUS, ABILITY_KEEN_EYE, ABILITY_PICKPOCKET }, // copied sneasel
        .bodyColor = BODY_COLOR_BLACK,
    ...
    [SPECIES_URSARING] =
    {
        ...
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD),
    #if P_UPDATED_ABILITIES >= GEN_4
        .abilities = { ABILITY_GUTS, ABILITY_UNNERVE, ABILITY_INTIMIDATE }, //2 Unnerve, 3 Intimidate
    #else
    ...
    [SPECIES_SWINUB] =
    {
        ...
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD),
    #if P_UPDATED_ABILITIES >= GEN_4
        .abilities = { ABILITY_OBLIVIOUS, ABILITY_STAMINA, ABILITY_SLUSH_RUSH }, //2 STAMINA, 3 SLUSH RUSH
    #else
    ...
    [SPECIES_CORSOLA] =
    {
        ...
        .abilities = { ABILITY_SOLID_ROCK, ABILITY_NATURAL_CURE, ABILITY_REGENERATOR }, //1 SOLID ROCK
        .bodyColor = BODY_COLOR_PINK,
    ...
    #if P_UPDATED_ABILITIES >= GEN_4
        .abilities = { ABILITY_SWIFT_SWIM, ABILITY_SNIPER, ABILITY_MOODY }, //1 SWIFT SWIM
    #else
    ...
    [SPECIES_OCTILLERY] =
    {
        ...
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_WATER_1, EGG_GROUP_WATER_2),
    #if P_UPDATED_ABILITIES >= GEN_4
        .abilities = { ABILITY_SUCTION_CUPS, ABILITY_MEGA_LAUNCHER, ABILITY_MOODY },//2 MEGA LAUNCHER
    #else
    ...
    [SPECIES_DELIBIRD] =
    {
        ...
        .growthRate = GROWTH_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_WATER_1, EGG_GROUP_FIELD),
        .abilities = { ABILITY_VITAL_SPIRIT, ABILITY_REFRIGERATE, ABILITY_PRANKSTER },//2 REFRIDGERATE, 3 PRANKSTER
        .bodyColor = BODY_COLOR_RED,
        .noFlip = TRUE,
    ...
    [SPECIES_MANTYKE] =
    {
        ...
        .growthRate = GROWTH_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_NO_EGGS_DISCOVERED),
        .abilities = { ABILITY_SWIFT_SWIM, ABILITY_WATER_VEIL, ABILITY_CUTE_CHARM }, //1 SWIFT SWIM, 2 WATER VEIL, 3 CUTE CHARM
        .bodyColor = BODY_COLOR_BLUE,
    ...
    [SPECIES_MANTINE] =
    {
        ...
        .abilities = { ABILITY_FRIEND_GUARD, ABILITY_WATER_VEIL, ABILITY_INTIMIDATE }, //1 FRIEND GUARD, 2 WATER VEIL, 3 INTIMIDATE
        .bodyColor = BODY_COLOR_PURPLE,
    ...
    [SPECIES_SKARMORY] =
    {
        ...
        .growthRate = GROWTH_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FLYING),
        .abilities = { ABILITY_ANGER_POINT, ABILITY_LIGHT_METAL, ABILITY_INTIMIDATE }, //1 ANGER pOINT, 2 LIGHT METAL, 3 INTIMIDATE
        .bodyColor = BODY_COLOR_GRAY,
    ...
    [SPECIES_PHANPY] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD),
        .abilities = { ABILITY_RUN_AWAY, ABILITY_HUSTLE, ABILITY_SPEED_BOOST }, //1 RUNAWAY, 2 HUSTLE,  3 SPEED BOOST
        .bodyColor = BODY_COLOR_BLUE,
    ...
    [SPECIES_DONPHAN] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD),
        .abilities = { ABILITY_SAND_RUSH, ABILITY_HUGE_POWER, ABILITY_SPEED_BOOST }, //1 SAND RUSH, 2 HUGE POWER, 3 SPEED BOOST
        .bodyColor = BODY_COLOR_GRAY,
    ...
    [SPECIES_MILTANK] =
    {
        ...
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD),
    #if P_UPDATED_ABILITIES >= GEN_4
        .abilities = { ABILITY_THICK_FAT, ABILITY_SCRAPPY, ABILITY_HOSPITALITY }, //3 HOSPITALITY
    #else
    ...
    [SPECIES_PUPITAR] =
    {
        ...
        .growthRate = GROWTH_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_MONSTER),
        .abilities = { ABILITY_SHED_SKIN, ABILITY_NONE, ABILITY_BATTLE_ARMOR },//3 BATTLE_ARMOR
        .bodyColor = BODY_COLOR_GRAY,
