...
#define RALTS_FAMILY_TYPE2 (P_UPDATED_TYPES >= GEN_6 ? TYPE_FAIRY : TYPE_PSYCHIC)
    ...
    [SPECIES_VOLBEAT] =
    {
        ...
        .types = MON_TYPES(TYPE_BUG, TYPE_FIRE), //Added fire type (Firefly)
        .catchRate = 150,
    #if P_UPDATED_EXP_YIELDS >= GEN_7
        .expYield = 151,
    #elif P_UPDATED_EXP_YIELDS >= GEN_5
    ...
    [SPECIES_ILLUMISE] =
    {
        ...
        .baseSpAttack  = 73,
        .baseSpDefense = P_UPDATED_STATS >= GEN_7 ? 85 : 75,
        .types = MON_TYPES(TYPE_BUG, TYPE_ELECTRIC), //Added electric type (Lightning bug)
        .catchRate = 150,
    #if P_UPDATED_EXP_YIELDS >= GEN_7
        .expYield = 151,
    #elif P_UPDATED_EXP_YIELDS >= GEN_5
    ...
    [SPECIES_CHIMECHO] =
    {
        ...
        .types = MON_TYPES(TYPE_PSYCHIC, TYPE_FAIRY), //ADDED FAIRY TYPE
        .catchRate = 45,
    #if P_UPDATED_EXP_YIELDS >= GEN_7
        .expYield = 159,
    #elif P_UPDATED_EXP_YIELDS >= GEN_5
