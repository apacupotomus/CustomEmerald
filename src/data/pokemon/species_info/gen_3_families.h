...
const struct SpeciesInfo gSpeciesInfoGen3[] =
{
    ...
    [SPECIES_POOCHYENA] =
    {
        ...
        .abilities = { ABILITY_QUICK_FEET, ABILITY_KEEN_EYE, ABILITY_RATTLED },//2 KEEN EYE
    #else
    ...
    [SPECIES_MIGHTYENA] =
    {
        ...
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD),
    #if P_UPDATED_ABILITIES >= GEN_4
        .abilities = { ABILITY_INTIMIDATE, ABILITY_GUARD_DOG, ABILITY_MOXIE }, //2 GUARD DOG
    #else
    ...
    [SPECIES_ZIGZAGOON] =
    {
        ...
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD),
    #if P_UPDATED_ABILITIES >= GEN_4
        .abilities = { ABILITY_PICKUP, ABILITY_QUICK_FEET, ABILITY_IMMUNITY }, //QUICK_FEET 2, IMMUNITY 3
    #else
    ...
    [SPECIES_LINOONE] =
    {
        ...
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD),
    #if P_UPDATED_ABILITIES >= GEN_4
        .abilities = { ABILITY_PICKUP, ABILITY_SCRAPPY, ABILITY_IMMUNITY }, //SCRAPPY 2, IMMUNITY 3
    #else
        .abilities = { ABILITY_PICKUP, ABILITY_NONE, ABILITY_QUICK_FEET },
    #endif
    ...
    [SPECIES_BEAUTIFLY] =
    {
        ...
        .baseSpDefense = 50,
        .types = MON_TYPES(TYPE_BUG, TYPE_FAIRY), //CHAGED TO BUG/FAIRY
        .catchRate = 45,
    #if P_UPDATED_EXP_YIELDS >= GEN_8
        .expYield = 198,
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_BUG),
        .abilities = { ABILITY_SWARM, ABILITY_NONE, ABILITY_MISTY_SURGE }, // 3 MISTY SURGE
    ...
    [SPECIES_DUSTOX] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_BUG),
        .abilities = { ABILITY_ANTICIPATION, ABILITY_NONE, ABILITY_TOXIC_DEBRIS }, //1 ANTICIPATION, 3 TOXIC DEBRIS
        .bodyColor = BODY_COLOR_GREEN,
    ...
    [SPECIES_NUZLEAF] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD, EGG_GROUP_GRASS),
        .abilities = { ABILITY_CHLOROPHYLL, ABILITY_LIMBER, ABILITY_PICKPOCKET }, //2 LIMBER
        .bodyColor = BODY_COLOR_BROWN,
    ...
    [SPECIES_WINGULL] =
    {
        ...
        .abilities = { ABILITY_KEEN_EYE, ABILITY_KEEN_EYE, ABILITY_HYDRATION }, // 2 KEEN EYE, 3 HYDRATION
    #else
    ...
    [SPECIES_PELIPPER] =
    {
        ...
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_WATER_1, EGG_GROUP_FLYING),
    #if P_UPDATED_ABILITIES >= GEN_7
        .abilities = { ABILITY_GULP_MISSILE, ABILITY_GULP_MISSILE, ABILITY_GLUTTONY }, // 1 2 GULP MISSLE, GLUTTONY
    #else
        .abilities = { ABILITY_KEEN_EYE, ABILITY_NONE, ABILITY_RAIN_DISH },
    #endif
        .bodyColor = BODY_COLOR_YELLOW,
...
#define RALTS_FAMILY_TYPE2 (P_UPDATED_TYPES >= GEN_6 ? TYPE_FAIRY : TYPE_PSYCHIC)
    ...
    [SPECIES_SURSKIT] =
    {
        ...
        .abilities = { ABILITY_QUICK_FEET, ABILITY_NONE, ABILITY_RAIN_DISH },
        .bodyColor = BODY_COLOR_BLUE,
    ...
    [SPECIES_MASQUERAIN] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_WATER_1, EGG_GROUP_BUG),
        .abilities = { ABILITY_INTIMIDATE, ABILITY_NONE, ABILITY_GALE_WINGS }, //GALE WINGS
        .bodyColor = BODY_COLOR_BLUE,
    ...
    [SPECIES_SLAKING] =
    {
        ...
        .growthRate = GROWTH_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD),
        .abilities = { ABILITY_SLOW_START, ABILITY_NONE, ABILITY_NONE }, //Changed to Slow Start may alter Truant to work like a hyper beam
        .bodyColor = BODY_COLOR_BROWN,
    ...
    [SPECIES_NOSEPASS] =
    {
        ...
        .baseSpAttack  = 45,
        .baseSpDefense = 90,
        .types = MON_TYPES(TYPE_ROCK, TYPE_ELECTRIC), //Added Electric Type
        .catchRate = 255,
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_MINERAL),
        .abilities = { ABILITY_VOLT_ABSORB, ABILITY_MAGNET_PULL, ABILITY_GALVANIZE }, // 1 VOLT_ABSORB, 3 GALVANIZE
        .bodyColor = BODY_COLOR_GRAY,
    ...
    [SPECIES_PROBOPASS] =
    {
        ...
        .baseSpAttack  = 75,
        .baseSpDefense = 150,
        .types = MON_TYPES(TYPE_STEEL, TYPE_ELECTRIC), //Swapped from Rock/Steel to Steel/Electric
        .catchRate = 60,
    ...
    [SPECIES_SABLEYE] =
    {
        ...
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_HUMAN_LIKE),
    #if P_UPDATED_ABILITIES >= GEN_4
        .abilities = { ABILITY_PRANKSTER, ABILITY_TOUGH_CLAWS, ABILITY_MAGIC_BOUNCE }, //1 PRANKSTER, 2 TOUGH CLAWS, 3 MAGIC BOUNCE
    #else
    ...
    [SPECIES_MAWILE] =
    {
        ...
        .growthRate = GROWTH_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD, EGG_GROUP_FAIRY),
        .abilities = { ABILITY_HYPER_CUTTER, ABILITY_INTIMIDATE, ABILITY_HUGE_POWER }, //3 HUGE POWER
    ...
    [SPECIES_ARON] =
    {
        ...
        .abilities = { ABILITY_STURDY, ABILITY_ROCK_HEAD, ABILITY_COMPETITIVE },
        .bodyColor = BODY_COLOR_GRAY,
        .speciesName = _("Aron"),
        .cryId = CRY_ARON,
    ...
    [SPECIES_LAIRON] =
    {
        ...
        .baseSpAttack  = 50,
        .baseSpDefense = 50,
        .types = MON_TYPES(TYPE_STEEL), //REMOVED ROCK
        .catchRate = 90,
        ...
        .growthRate = GROWTH_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_MONSTER),
        .abilities = { ABILITY_HEAVY_METAL, ABILITY_ROCK_HEAD, ABILITY_COMPETITIVE },
        .bodyColor = BODY_COLOR_GRAY,
    ...
    [SPECIES_AGGRON] =
    {
        ...
        .baseSpAttack  = 60,
        .baseSpDefense = 60,
        .types = MON_TYPES(TYPE_STEEL, TYPE_DRAGON), //cHANGED TO STEEL DRAGON
        .catchRate = 45,
    #if P_UPDATED_EXP_YIELDS >= GEN_8
        .expYield = 265,
    #elif P_UPDATED_EXP_YIELDS >= GEN_5
        ...
        .growthRate = GROWTH_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_MONSTER),
        .abilities = { ABILITY_HEAVY_METAL, ABILITY_ROCK_HEAD, ABILITY_COMPETITIVE }, // 1 HEAVY METAL, 3 COMPETITIVE
        .bodyColor = BODY_COLOR_GRAY,
    ...
    [SPECIES_ELECTRIKE] =
    {
        ...
        .growthRate = GROWTH_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD),
        .abilities = { ABILITY_STATIC, ABILITY_LIGHTNING_ROD, ABILITY_ELECTRIC_SURGE }, //3 ELECTRIC SURGE
        .bodyColor = BODY_COLOR_GREEN,
    ...
    [SPECIES_VOLBEAT] =
    {
        ...
        .types = MON_TYPES(TYPE_BUG, TYPE_ELECTRIC), //Added fire type (Lightningbug)
        .catchRate = 150,
    #if P_UPDATED_EXP_YIELDS >= GEN_7
        .expYield = 151,
    #elif P_UPDATED_EXP_YIELDS >= GEN_5
        ...
        .abilities = { ABILITY_ILLUMINATE, ABILITY_SWARM, ABILITY_VOLT_ABSORB },//Swapped Prankster with Volt Absorb
        .bodyColor = BODY_COLOR_GRAY,
        .speciesName = _("Volbeat"),
        .cryId = CRY_VOLBEAT,
        .natDexNum = NATIONAL_DEX_VOLBEAT,
        .categoryName = _("Lightningbug"),  // Changed from "Firefly"
        .height = 7,
        .weight = 177,
        .description = COMPOUND_STRING(
    ...
    [SPECIES_ILLUMISE] =
    {
        ...
        .baseSpAttack  = 73,
        .baseSpDefense = P_UPDATED_STATS >= GEN_7 ? 85 : 75,
        .types = MON_TYPES(TYPE_BUG, TYPE_FAIRY), //Added fairy type)
        .catchRate = 150,
    #if P_UPDATED_EXP_YIELDS >= GEN_7
        .expYield = 151,
    #elif P_UPDATED_EXP_YIELDS >= GEN_5
        ...
        .categoryName = _("Twinklebug"),  //Changed from "Firefly" to "Twinklebug"
        .height = 6,
        .weight = 177,
        .description = COMPOUND_STRING(
    ...
    [SPECIES_CARVANHA] =
    {
        ...
        .abilities = { ABILITY_ROUGH_SKIN, ABILITY_SWIFT_SWIM, ABILITY_SPEED_BOOST }, // 2 SWIFT SWIM
        .bodyColor = BODY_COLOR_RED,
    ...
    [SPECIES_SHARPEDO] =
    {
        ...
        .growthRate = GROWTH_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_WATER_2),
        .abilities = { ABILITY_ROUGH_SKIN, ABILITY_STRONG_JAW, ABILITY_SPEED_BOOST },// 2 STRONG JAW
        .bodyColor = BODY_COLOR_BLUE,
    ...
    [SPECIES_WAILMER] =
    {
        ...
        .abilities = { ABILITY_BULLETPROOF, ABILITY_DAMP, ABILITY_DRIZZLE }, // 1 BULLETPROOF, 2 DAMP, 3 DRIZZLE
        .bodyColor = BODY_COLOR_BLUE,
    ...
    [SPECIES_NUMEL] =
    {
        ...
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD),
    #if P_UPDATED_ABILITIES >= GEN_4
        .abilities = { ABILITY_MAGMA_ARMOR, ABILITY_SIMPLE, ABILITY_CUD_CHEW }, // 1 MAGMA ARMOR, 3 CUD CHEW
    #else
    ...
    [SPECIES_FLYGON] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_SLOW,
        .eggGroups = TRAPINCH_FAMILY_EGG_GROUPS,
        .abilities = { ABILITY_AIRBORNE, ABILITY_NONE, ABILITY_NONE }, //future ability Airborne
        .bodyColor = BODY_COLOR_GREEN,
    ...
    [SPECIES_SWABLU] =
    {
        ...
        .baseSpAttack  = 40,
        .baseSpDefense = 75,
        .types = MON_TYPES(TYPE_FAIRY, TYPE_FLYING), //Swapped Normal/flying with Fairy flying
        .catchRate = 255,
    ...
    [SPECIES_ALTARIA] =
    {
        ...
        .baseSpAttack  = 70,
        .baseSpDefense = 105,
        .types = MON_TYPES(TYPE_FAIRY, TYPE_DRAGON), //Swapped Dragon/Flying with Fairy/Dragon
        .catchRate = 45,
    ...
    [SPECIES_SEVIPER] =
    {
        ...
        .abilities = { ABILITY_MERCILESS, ABILITY_NONE, ABILITY_POISON_TOUCH },
        .bodyColor = BODY_COLOR_BLACK,
        .noFlip = TRUE,
    ...
    [SPECIES_BARBOACH] =
    {
        ...
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_WATER_2),
    #if P_UPDATED_ABILITIES >= GEN_4
        .abilities = { ABILITY_OBLIVIOUS, ABILITY_ANTICIPATION, ABILITY_GOOEY },
    #else
    ...
    [SPECIES_WHISCASH] =
    {
        ...
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_WATER_2),
    #if P_UPDATED_ABILITIES >= GEN_4
        .abilities = { ABILITY_DAMP, ABILITY_FOREWARN, ABILITY_EARTH_EATER },
    #else
        .abilities = { ABILITY_OBLIVIOUS, ABILITY_NONE, ABILITY_HYDRATION },
    #endif
        .bodyColor = BODY_COLOR_BLUE,
    ...
    [SPECIES_ARMALDO] =
    {
        ...
        .growthRate = GROWTH_ERRATIC,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_WATER_3),
        .abilities = { ABILITY_BATTLE_ARMOR, ABILITY_NONE, ABILITY_WATER_COMPACTION }, //3 WATER COMPACTION
        .bodyColor = BODY_COLOR_GRAY,
    ...
    [SPECIES_MILOTIC] =
    {
        ...
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_WATER_1, EGG_GROUP_DRAGON),
    #if P_UPDATED_ABILITIES >= GEN_4
        .abilities = { ABILITY_MARVEL_SCALE, ABILITY_CUTE_CHARM, ABILITY_COMPETITIVE }, //SWAPPED 2 AND 3
    #else
...
#if P_FAMILY_CASTFORM //Need to add a sandstorm form
    ...
    [SPECIES_SHUPPET] =
    {
        ...
        .baseSpAttack  = 63,
        .baseSpDefense = 33,
        .types = MON_TYPES(TYPE_GHOST, TYPE_NORMAL), //ADDED NORMAL TYPE
        .catchRate = 225,
        ...
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_AMORPHOUS),
    #if P_UPDATED_ABILITIES >= GEN_4
        .abilities = { ABILITY_CURSED_BODY, ABILITY_FRISK, ABILITY_PERISH_BODY }, //1 CURSED BODY, 3 PERISH BODY
    #else
    ...
    [SPECIES_DUSCLOPS] =
    {
        ...
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_AMORPHOUS),
    #if P_UPDATED_ABILITIES >= GEN_6
        .abilities = { ABILITY_SOUL_EATER, ABILITY_SOUL_EATER, ABILITY_FRISK },
    #else
    ...
    [SPECIES_DUSKNOIR] =
    {
        ...
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_AMORPHOUS),
    #if P_UPDATED_ABILITIES >= GEN_6
        .abilities = { ABILITY_SOUL_EATER, ABILITY_SOUL_EATER, ABILITY_NO_GUARD }, //SOUL EATER NEW AB. 3 NO GUARD
    #else
        .abilities = { ABILITY_PRESSURE, ABILITY_NONE, ABILITY_NONE },
    #endif
        .bodyColor = BODY_COLOR_BLACK,
    ...
    #if P_UPDATED_ABILITIES >= GEN_4
        .abilities = { ABILITY_THICK_FAT, ABILITY_SOLAR_POWER, ABILITY_HARVEST }, //1 THICK FAT
    #else
    ...
    [SPECIES_CHIMECHO] =
    {
        ...
        .types = MON_TYPES(TYPE_PSYCHIC, TYPE_STEEL), //ADDED STEEL TYPE
        .catchRate = 45,
    #if P_UPDATED_EXP_YIELDS >= GEN_7
        .expYield = 159,
    #elif P_UPDATED_EXP_YIELDS >= GEN_5
    ...
    [SPECIES_GLALIE] =
    {
        ...
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FAIRY, EGG_GROUP_MINERAL),
    #if P_UPDATED_ABILITIES >= GEN_4
        .abilities = { ABILITY_SNOW_WARNING, ABILITY_SNOW_WARNING, ABILITY_ICE_BODY },//Changed ability 1 and 2 to snow warning
    #else
        .abilities = { ABILITY_INNER_FOCUS, ABILITY_NONE, ABILITY_ICE_BODY },
    #endif
        .bodyColor = BODY_COLOR_GRAY,
    ...
    [SPECIES_SEALEO] =
    {
        ...
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_WATER_1, EGG_GROUP_FIELD),
    #if P_UPDATED_ABILITIES >= GEN_4
        .abilities = { ABILITY_THICK_FAT, ABILITY_ICE_BODY, ABILITY_REFRIGERATE }, //3 REFRIDGERATE
    #else
        .abilities = { ABILITY_THICK_FAT, ABILITY_NONE, ABILITY_OBLIVIOUS },
    #endif
        .bodyColor = BODY_COLOR_BLUE,
    ...
    [SPECIES_LUVDISC] =
    {
        ...
        .growthRate = GROWTH_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_WATER_2),
        .abilities = { ABILITY_SWIFT_SWIM, ABILITY_NONE, ABILITY_CUTE_CHARM }, //CUTE CHARM
        .bodyColor = BODY_COLOR_PINK,
    ...
    [SPECIES_METAGROSS] =
    {
        ...
        .growthRate = GROWTH_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_MINERAL),
        .abilities = { ABILITY_CLEAR_BODY, ABILITY_NONE, ABILITY_ANALYTIC }, //3 ANALYTIC
        .bodyColor = BODY_COLOR_BLUE,
    ...
    [SPECIES_REGIROCK] =
    {
        ...
        .growthRate = GROWTH_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_NO_EGGS_DISCOVERED),
        .abilities = { ABILITY_ARENA_TRAP, ABILITY_NONE, ABILITY_SOLID_ROCK },//1, arena trap 3 SOLID_ROCK
        .bodyColor = BODY_COLOR_BROWN,
        .noFlip = TRUE,
    ...
    [SPECIES_REGICE] =
    {
        ...
        .growthRate = GROWTH_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_NO_EGGS_DISCOVERED),
        .abilities = { ABILITY_ARENA_TRAP, ABILITY_NONE, ABILITY_ICE_BODY }, //1 Arena Trap
        .bodyColor = BODY_COLOR_BLUE,
    ...
    [SPECIES_REGISTEEL] =
    {
        ...
        .growthRate = GROWTH_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_NO_EGGS_DISCOVERED),
        .abilities = { ABILITY_ARENA_TRAP, ABILITY_NONE, ABILITY_STEELWORKER }, //1 Arena Trap
        .bodyColor = BODY_COLOR_GRAY,
